...
function useUserState() {
  var _useState = useState(mascotasState.user),
      user = _useState[0],
      setUser = _useState[1];
...
function useTokenState() {
  var _useState2 = useState(mascotasState.token),
      token = _useState2[0],
...
export { StateInfo, cleanupStore, mascotasState, securedAxios, updateStoreToken, updateStoreUser, useTokenState, useUserState };
